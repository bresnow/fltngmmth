...
export const loader: LoaderFunction = async ({ params, request, context }) => {
  ...
  let keys = await gun.keys(['bresnow', 'password'])
  let db = gun.vault('tester', keys)
  db.get('test_data').put({ loader: 'rootData', putter: 'Data is being pulled from the database like a boss' })
