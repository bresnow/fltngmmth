...
export let paths = {
  ...
  codepen: {
    name: 'CodePen',
    svgPath:
      'M427 201.9c-0.6-4.2-2.9-8-6.4-10.3L264.2 87.3c-4.9-3.3-11.4-3.3-16.3 0L91.4 191.6c-4 2.7-6.5 7.4-6.5 12.2v104.3c0 4.8 2.5 9.6 6.5 12.2l156.4 104.3c4.9 3.3 11.4 3.3 16.3 0L420.6 320.4c4-2.6 6.6-7.4 6.6-12.2V203.9C427.1 203.2 427.1 202.6 427 201.9 427 201.7 427.1 202.6 427 201.9zM270.7 127.1l115.2 76.8 -51.5 34.4 -63.8-42.7V127.1zM241.3 127.1v68.6l-63.8 42.7 -51.5-34.4L241.3 127.1zM114.3 231.4l36.8 24.6 -36.8 24.6V231.4zM241.3 384.9L126.1 308.1l51.5-34.4 63.8 42.6V384.9zM256 290.8l-52-34.8 52-34.8 52 34.8L256 290.8zM270.7 384.9V316.3l63.8-42.6 51.5 34.4L270.7 384.9zM397.7 280.6l-36.8-24.6 36.8-24.6V280.6z',
    to: '',
    fill: '',
  },
  ...
  delicious: {
    name: 'Delicious',
    svgPath:
      'M120 120v271.9h271.9V120H120zM365.6 365.6H256V256H146.4V146.4H256V256h109.6V365.6z',
    to: '',
    fill: '',
  },
  ...
  deviantArt: {
    name: 'DeviantART',
    svgPath:
      'M251 214.4c66.8-1.2 102.7 20.7 111.4 63.3h-54.6v-45.8c-14.4-5-29.6-7.1-45.4-6.9v86.6h178.2c-8.6-69.1-88-123.3-184.6-123.3 -1.7 0-3.3 0-5 0.1v-31.7c-15.2-1-30.1 1.4-44.7 7.8v28.8c-73 14.8-127.8 61.5-134.9 118.4h179.6L251 214.4 251 214.4zM206.3 277.7H150.2c6-29.2 24.7-48.6 56.1-56.9V277.7z',
    to: '',
    fill: '',
  },
  ...
  instagram: {
    name: 'Instagram',
    svgPath:
      'M256 164.1c-50.7 0-91.9 41.1-91.9 91.9s41.1 91.9 91.9 91.9 91.9-41.1 91.9-91.9S306.7 164.1 256 164.1zM256 315.6c-32.9 0-59.6-26.7-59.6-59.6s26.7-59.6 59.6-59.6 59.6 26.7 59.6 59.6S288.9 315.6 256 315.6z',
    to: '',
    fill: '',
  },
  ...
  vimeo: {
    name: 'Vimeo',
    svgPath:
      'M420.1 197.9c-1.5 33.6-25 79.5-70.3 137.8 -46.9 60.9-86.5 91.4-118.9 91.4 -20.1 0-37.1-18.5-51-55.6 -9.3-34-18.5-68-27.8-102 -10.3-37.1-21.4-55.7-33.2-55.7 -2.6 0-11.6 5.4-27 16.2L75.7 209.1c17-14.9 33.8-29.9 50.3-44.9 22.7-19.6 39.7-29.9 51.1-31 26.8-2.6 43.3 15.8 49.5 55 6.7 42.4 11.3 68.7 13.9 79 7.7 35.1 16.2 52.7 25.5 52.7 7.2 0 18-11.4 32.5-34.2 14.4-22.8 22.2-40.1 23.2-52.1 2.1-19.7-5.7-29.5-23.2-29.5 -8.3 0-16.8 1.9-25.5 5.7 16.9-55.5 49.3-82.4 97.1-80.9C405.5 130 422.2 153 420.1 197.9z',
    to: '',
    fill: '',
  },
...
const SvgIcons = () => {
  return {
    ...
    track: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    behance: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.behance.svgPath} fill={fill} size={size} />;
    },

    codepen: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.codepen.svgPath} fill={fill} size={size} />;
    },

    delicious: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.delicious.svgPath} fill={fill} size={size} />;
    },

    deviantArtfunction({ fill, size }: { fill?: string; size?: string }) {
      return (
        <SvgIcon path={paths.deviantArt.svgPath} fill={fill} size={size} />
      );
    },

    dribble: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.dribble.svgPath} fill={fill} size={size} />;
    },

    email: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.email.svgPath} fill={fill} size={size} />;
    },

    etsy: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.etsy.svgPath} fill={fill} size={size} />;
    },

    facebook: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.facebook.svgPath} fill={fill} size={size} />;
    },

    forrst: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.forrst.svgPath} fill={fill} size={size} />;
    },

    gitHub: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    keybase: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    instagram: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    last_fm: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    linkedIn: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    reddit: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    payPal: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    pinterest: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    RSS: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    soundCloudfunction({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    stackOverffunction({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    stumbleUpofunction({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    tumblr: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    twitter: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    vimeo: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    youTube: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    yelp: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    foursquarefunction({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },

    spotify: function ({ fill, size }: { fill?: string; size?: string }) {
      return <SvgIcon path={paths.track.svgPath} fill={fill} size={size} />;
    },
  };
};
